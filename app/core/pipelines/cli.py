...
Usage:
    python -m app.pipelines.cli ingest --doc-dir /path/to/documents
    python -m app.pipelines.cli sync --rebuild
    python -m app.pipelines.cli search --query "Your search query"
"""
    ...
    try:
        if args.command == 'ingest':
            ...
            if hasattr(args, 'log_level'):
                ...
                for logger_name in ['app', 'app.query', 'app.core.pipelines']:
