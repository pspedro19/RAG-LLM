...
class FAISSVectorStore:
    ...
    def clear_index(self):
        """Limpia el índice FAISS, creando uno nuevo vacío."""
        logger = logging.getLogger("app.core.faiss_manager")
        logger.info("Limpiando índice FAISS...")
        
        # Crear un nuevo índice vacío con la dimensión configurada
        ...
        logger.info(f"Índice FAISS limpiado y recreado con dimensión {dimension}")
        return True