...
class RAGIntegrationTest:
    ...
    async def synchronize_faiss(self):
        ...
        from app.core.sync.sync_faiss import rebuild_faiss_index
...
async def main():
    ...
    parser.add_argument('--doc-dir', type=str, default='/root/LLMBitlink/app/data/documents/pdf/curaçao_information',
